...
TwitterApi.prototype = {
    ...
    getRequestToken: function( query){
        var deferred = q.defer();
        ...
        signatureParams.push( {key: 'oauth_callback', value: 'http://localhost:3000/#/userTweets'},
            ...
            {key: 'oauth_nonce', value: oauth.generateNonce()},
        ...
        var oauthSignature = encodeURIComponent(oauth.buildSignature(signatureParams, url, method, this.config.consumerSecret));
    ...
    requestByUser: function(fullUrl, queryParams){
        ...
        var requestToken = this.getRequestToken(queryParams);
